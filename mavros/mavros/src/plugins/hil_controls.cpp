	...
	const message_map get_rx_handlers() {
		return {
			       //MESSAGE_HANDLER(MAVLINK_MSG_ID_HIL_CONTROLS, &HilControlsPlugin::handle_hil_controls),
					MESSAGE_HANDLER(MAVLINK_MSG_ID_HIL_ACTUATOR_CONTROLS, &HilControlsPlugin::handle_hil_controls),
		};
	}
...
/*		hil_controls_msg->pitch_elevator = hil_controls.pitch_elevator;
		...
		hil_controls_msg->roll_ailerons = hil_controls.controls[0];
		hil_controls_msg->pitch_elevator = hil_controls.controls[1];
		hil_controls_msg->yaw_rudder = hil_controls.controls[2];
		hil_controls_msg->throttle = hil_controls.controls[3];
		hil_controls_msg->aux1 = hil_controls.controls[4];
		hil_controls_msg->aux2 = hil_controls.controls[5];
		hil_controls_msg->aux3 = hil_controls.controls[6];
		hil_controls_msg->aux4 = hil_controls.controls[7];
		hil_controls_msg->mode = hil_controls.mode;
		hil_controls_msg->nav_mode = hil_controls.flags;
